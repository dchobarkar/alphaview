...
const Page = () => {
  return (
    <div>
      <h1>Digital Currency Daily</h1>
      <p>
        This API returns the daily historical time series for a digital currency
        (e.g., BTC) traded on a specific market (e.g., EUR/Euro), refreshed
      ...
      <form className="p-4 space-y-4 bg-gray-100 rounded-lg shadow-md max-w-md mx-auto">
        <InputBox inputList={cryptocurrenciesInputs.daily} />
