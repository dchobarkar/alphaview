...
const Page = () => {
  return (
    <div>
      <h1>Global Price of Wheat</h1>
      <p>
        This API returns the global price of wheat in monthly, quarterly, and
        annual horizons.
        <br />
        Source: International Monetary Fund (IMF Terms of Use), Global price of
        Wheat, retrieved from FRED, Federal Reserve Bank of St. Louis. This data
        feed uses the FRED® API but is not endorsed or certified by the Federal
      ...
      <form className="p-4 space-y-4 bg-gray-100 rounded-lg shadow-md max-w-md mx-auto">
        <InputBox inputList={commoditiesInputs.wheat} />
