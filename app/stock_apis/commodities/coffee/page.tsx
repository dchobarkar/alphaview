...
const Page = () => {
  return (
    <div>
      <h1>Global Price of Coffee</h1>
      <p>
        This API returns the global price of coffee in monthly, quarterly, and
        annual horizons.
        <br />
        Source: International Monetary Fund (IMF Terms of Use), Global price of
        Coffee, Other Mild Arabica, retrieved from FRED, Federal Reserve Bank of
      ...
      <form className="p-4 space-y-4 bg-gray-100 rounded-lg shadow-md max-w-md mx-auto">
        <InputBox inputList={commoditiesInputs.coffee} />
