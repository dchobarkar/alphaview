...
const Page = () => {
  return (
    <div>
      <h1>Global Price of Copper</h1>
      <p>
        This API returns the global price of copper in monthly, quarterly, and
        annual horizons.
        <br />
        Source: International Monetary Fund (IMF Terms of Use), Global price of
        Copper, retrieved from FRED, Federal Reserve Bank of St. Louis. This
      ...
      <form className="p-4 space-y-4 bg-gray-100 rounded-lg shadow-md max-w-md mx-auto">
        <InputBox inputList={commoditiesInputs.copper} />
