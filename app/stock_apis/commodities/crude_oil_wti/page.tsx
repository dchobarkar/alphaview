...
const Page = () => {
  return (
    <div>
      <h1>Crude Oil Prices: West Texas Intermediate (WTI)</h1>
      <p>
        This API returns the West Texas Intermediate (WTI) crude oil prices in
        daily, weekly, and monthly horizons.
        <br /> Source: U.S. Energy Information Administration, Crude Oil Prices:
        West Texas Intermediate (WTI) - Cushing, Oklahoma, retrieved from FRED,
      ...
      <form className="p-4 space-y-4 bg-gray-100 rounded-lg shadow-md max-w-md mx-auto">
        <InputBox inputList={commoditiesInputs.cruidOilWTI} />
