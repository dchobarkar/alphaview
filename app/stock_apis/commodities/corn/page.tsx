...
const Page = () => {
  return (
    <div>
      <h1>Global Price of Corn</h1>
      <p>
        This API returns the global price of corn in monthly, quarterly, and
        annual horizons.
        <br />
        Source: International Monetary Fund (IMF Terms of Use), Global price of
        Corn, retrieved from FRED, Federal Reserve Bank of St. Louis. This data
      ...
      <form className="p-4 space-y-4 bg-gray-100 rounded-lg shadow-md max-w-md mx-auto">
        <InputBox inputList={commoditiesInputs.corn} />
